...
class ShowProjectTemplateDialog(QDialog):
    ...
    def setupDialog(self):
        ...
        self.layout().addWidget(QLabel("<b>to the DPaW Tools menu and selecting 'Settings | Default Project | Set current project...'</b>"))
        self.layout().addWidget(QLabel(""))
    ...
    def alwaysUseSMBHandler(self):
        ...
        Tools.setSetting("showDefaultMapDialog", "false")
